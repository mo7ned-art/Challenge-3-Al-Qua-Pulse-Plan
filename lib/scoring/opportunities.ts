...
export const OPPORTUNITY_TEMPLATES: Array<OpportunityTemplate & { category: string; slug: string }> = [
  {
    ...
    description_ar: "خدمة توصيل أسبوعية تجلب أعلاف الإبل بالجملة للمزارع في شمال وجنوب القوع.",
  ...
  },
  {
    ...
    target_customer_ar: "أصحاب المزارع الصغيرة والمتوسطة في نطاق ٢٠ كم من القوع.",
  ...
  },
  {
    ...
    description_ar: "زيارات حجز تصليح مكيفات الهواء عند الطلب للمنازل والمزارع في جميع أنحاء القوع.",
    ...
    risks_ar: [
      ...
      "توفر قطع الغيار في القوع محدود — حافظ على مخزون صغير أو علاقة مع مورد في العين.",
  ...
  },
  {
    ...
    description_ar: "تصليح واستبدال الإطارات في الموقع للسيارات العالقة في الرحلات الطويلة إلى القوع.",
    target_customer: "Residents and visitors driving between Al Ain and Al Qua'a.",
    target_customer_ar: "السكان والزوار الذين يقودون سياراتهم بين العين والقوع.",
    ...
    first_actions_ar: [
      ...
      "نشر الخدمة في مجموعات واتساب في القوع.",
    ],
    risks: [
  ...
  },
  {
    ...
    title_ar: "توصيل بقالة القوع",
    description: "A weekly shared grocery delivery route that brings essentials from Al Ain supermarkets to Al Qua'a.",
    description_ar: "مسار توصيل بقالة مشترك أسبوعي يجلب الأساسيات من سوبرماركت العين إلى القوع.",
  ...
  },
  {
    ...
    first_actions_ar: [
      "البحث عن مخبز شريك في العين يوصل إلى القوع.",
  ...
  },
  {
    ...
    description_ar: "رحلات مشتركة مجدولة بين القوع والعين للزيارات الطبية، التسوق، والرحلات المدرسية.",
  ...
  },
  {
    ...
    description_ar: "تجربة سماء مظلمة موجهة للزوار في القوع — مرشد، وجبات خفيفة، مواقف سيارات، تلسكوب، وقصة محلية.",
  ...
  },
  {
    ...
    description_ar: "استئجار تلسكوب سهل للمبتدئين لقضاء أمسية بالقرب من القوع، مع دليل إعداد مدته ٥ دقائق.",
  ...
  },
  {
    ...
    description_ar: "مباراة كرة قدم منتظمة في عطلة نهاية الأسبوع للشباب والكبار في القوع، مع ترتيب بسيط وكأس صغير.",
